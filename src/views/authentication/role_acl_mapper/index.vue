  ...
  <div class="orderMessage">
    <section class="process">
      <el-steps :active="4">
        ...
        <el-step title="销售审核"  :description=user+date></el-step>
        <el-step title="技术审核"  :description=user+date></el-step>
        <el-step title="订单排单"  :description=user+date></el-step>
      </el-steps>
    </section>
    ...
    <div v-show="showTable">
      <div class="tableHeader">
        ...
        <el-table class="elTable" :data="tableHeaderdata" border style="max-width:921px;" >
          <el-table-column
            label="发文部门"
            width="140"
            prop="indentIdCN"
          ...
          <el-table-column align="center" label="操作" width="160" >
            <template slot-scope="scope">
              ...
              <el-button  v-else type="primary" disabled @click='setEdit(scope.row)' size="small" icon="el-icon-edit">编辑</el-button>
            </template>
          </el-table-column>

        </el-table>    
        <div class="exportBtnList">
      ...
      <section>
        <div class="check">
          <div>
            <label for="selectResult">审核结果：</label>
            <el-select v-model="value" id="selectResult" placeholder="请选择">
              <el-option
          ...
          <div class="checkText">
            <span>审核意见:</span>          
            <el-input v-model="inputCheckContent"  id="resultContent" placeholder="请输入内容"></el-input>
          </div>
        </div>
      </section>
      ...
      <section>
        <div class="technology">
          <div>
            <label for="selectResult">工艺流程：</label>
            <el-select v-model="value" id="selectResult" placeholder="请选择">
              <el-option
                v-for="item in optionsTechnology"
                :key="item.value"
                :label="item.label"
                :value="item.value">
              </el-option>
          ...
          <div class="checkText">
            <span>具体工艺:</span>          
            <el-input v-model="inputTechnologyContent"  id="resultContent" placeholder="请输入内容"></el-input>
          </div>
        </div>
      </section>

      <div class="subFuc">
        <el-button type="primary" size="medium" class="submit"><i class="el-icon-check"></i>提交销售部</el-button>
